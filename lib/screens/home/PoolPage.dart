// ignore_for_file: file_names, prefer_const_constructors, deprecated_member_use, unnecessary_new
...
class _PoolpageState extends State<Poolpage> {
  ...
  Widget dropdown() {
    return GFMultiSelect(
      ...
      dropdownTitleTileBorder: Border.all(color: Colors.black, width: 1),
                  ...
                  children: [
                    ...
                    Flexible(
                      child: DropdownButtonFormField<String>(
                        ...
                        items: <String>['One-Time', 'Frequent']
                            .map((String value) {
                          return DropdownMenuItem<String>(
                            value: value,
                            child: new Text(value),
                          ...
                          if (OpickupCtrl.text == '' ||
                            ...
                            showDialog(
                                ...
                                builder: (context) => AlertDialog(
                                      ...
                                      content: Text(
                                          "Please makesure all fields for offerring carpool are filled"),
                                      actions: [
                                        TextButton(
                                            onPressed: () {
                                              Navigator.pop(context);
                            ...
                            if (currentuser != null) {
                              ...
                              UserDataBaseService user =
                                  UserDataBaseService(uid: userid);
                    ...
                    if (FpickupCtrl.text == '' || FdropCtrl.text == '') {
                      showDialog(
                        ...
                        builder: (context) => AlertDialog(
                          title: Text('Incomplete Fields'),
                          content: Text(
                          "Please makesure all fields for finding carpool are filled"),
                          actions: [
                            TextButton(
                              onPressed: () {
                                Navigator.pop(context);
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (BuildContext context) => findcarpool(start: FpickupCtrl.text,destination: FdropCtrl.text,))
                      );
                      // try {
                      //   final result = await getDirections();
                      //   markers.clear();

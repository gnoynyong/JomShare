...
final searchScaffoldKey = GlobalKey<ScaffoldState>();
 TextEditingController DT = TextEditingController();
    ...
    final GlobalKey<FormState> _offerform = GlobalKey<FormState>();
void initState()
{
              ...
              child: Column(
                children: [
                  ...
                  Align(
                    ...
                    child: DateTimeField(
                      validator: (value) {
                        if (value==null&&DT.text!=widget.eoffer.datetime)
                        {
                      ...
                      Expanded(
                        ...
                        child: TextFormField(
                          validator: (value)
                          {
                            ...
                            if (value.length>15)
                            {
                              return "The length of plate No is too long";
                            }
                  ...
                  ElevatedButton(
                          ...
                          onPressed: () {
                             if(_offerform.currentState!.validate())
                             {
                               updateCarpool();
